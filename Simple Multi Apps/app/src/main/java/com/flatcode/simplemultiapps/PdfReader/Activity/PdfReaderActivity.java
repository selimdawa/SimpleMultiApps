...
public class PdfReaderActivity extends AppCompatActivity {
    ...
    private Activity activity = PdfReaderActivity.this;
    ...
    private ActivityPdfReaderBinding viewBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewBinding = ActivityPdfReaderBinding.inflate(getLayoutInflater());
    ...
    private void onFirstInstall() {
        boolean isFirstRun = prefManager.getBoolean(DATA.FIRST_INSTALL, true);
        if (isFirstRun) {
            startActivity(new Intent(activity, CLASS.PDF_READER_INTRO));
    ...
    void shareFile() {
        ...
        if (uri.getScheme() != null && uri.getScheme().startsWith("http")) {
            sharingIntent = VOID.plainTextShareIntent(getString(R.string.share_file), uri.toString());
        } else {
            sharingIntent = VOID.fileShareIntent(getString(R.string.share_file), pdfFileName, uri);
        }
    ...
    public void saveToFileAndDisplay(byte[] pdfFileContent) {
    ...
    private void printDocument() {
        mgr.print(pdfFileName, new PdfDocumentAdapter(activity, uri), null);
    }

    void askForPdfPassword() {
        DialogPdfReaderPasswordBinding dialogBinding = DialogPdfReaderPasswordBinding.inflate(getLayoutInflater());
